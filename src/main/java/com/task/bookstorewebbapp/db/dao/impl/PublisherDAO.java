...
public class PublisherDAO implements DAO<PublisherEntity> {
  ...
  @Override
  public <V> PublisherEntity getEntityByField(SearchField<V> fieldValue) throws SQLException {
    throw new UnsupportedOperationException();
  }

  @Override
  public <V> List<PublisherEntity> getEntitiesByField(V fieldValue) throws SQLException {
    throw new UnsupportedOperationException();
  }

  @Override
  public List<PublisherEntity> getEntities() throws SQLException {
    ...
    try(Connection con = connectionSupplier.getConnection();
      ...
      throw new SQLException("Can't retrieve publishers from database " + e.getMessage(), e);
    }
    return entities;
  }

  @Override
  public long insertEntity(PublisherEntity entity) throws SQLException {
    throw new UnsupportedOperationException();
  }

  @Override
  public boolean updateEntity(PublisherEntity entity) throws SQLException {
    throw new UnsupportedOperationException();
  }

  @Override
  public boolean deleteEntity(PublisherEntity entity) throws SQLException {
    throw new UnsupportedOperationException();  }
