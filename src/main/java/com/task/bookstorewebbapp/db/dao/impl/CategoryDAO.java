...
public class CategoryDAO implements DAO<CategoryEntity> {
  ...
  @Override
  public <V> CategoryEntity getEntityByField(SearchField<V> fieldValue) throws DAOException {
    return null;
  }

  @Override
  public <V> List<CategoryEntity> getEntitiesByField(V fieldValue) throws DAOException {
    return null;
  }

  @Override
  public List<CategoryEntity> getEntities() throws DAOException {
    ...
    try(Connection con = connectionSupplier.getConnection();
      ...
      throw new DAOException("Can't retrieve categories from database " + e.getMessage(), e);
    }
    return entities;
  }

  @Override
  public long insertEntity(CategoryEntity entity) throws DAOException {
    return 0;
  }

  @Override
  public boolean updateEntity(CategoryEntity entity) throws DAOException {
    return false;
  }

  @Override
  public boolean deleteEntity(CategoryEntity entity) throws DAOException {
    return false;
  }
